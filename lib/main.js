...
(function ($) {
  ...
  $('#comment-form').submit(function () {
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        $('.post_comments-form .notification').removeClass('is-danger').addClass('is-success');
        showAlert('<strong>Thanks for your comment!</strong> It will show on the site once it has been approved.');
      },
      error: function (err) {
        console.log(err);
        $('#comment-form-submit').html('Submit Comment');
        $('.post_comments-form .notification').removeClass('is-success').addClass('is-danger');
  ...
  function showAlert(message) {
    $('.post_comments-form .notification').removeClass('hidden');
    $('.post_comments-form .notificaiton-text').html(message);
  }
})(jQuery);
