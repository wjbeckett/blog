...
(function ($) {
  ...
  $('#comment-form').submit(function () {
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        $('.post_comments-form .js-notice').removeClass('is-danger').addClass('is-success');
        showAlert('<strong>Thanks for your comment!</strong> It will show on the site once it has been approved.');
      },
      error: function (err) {
        console.log(err);
        $('#comment-form-submit').html('Submit Comment');
        $('.post_comments-form .js-notice').removeClass('is-success').addClass('is-danger');
  ...
  function showAlert(message) {
    $('.post_comments-form .js-notice').removeClass('hidden');
    $('.post_comments-form .js-notice-text').html(message);
  }
})(jQuery);
