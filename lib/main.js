    ...
    $.ajax({
      ...
      success: function(data) {
        ...
        $("#js-notice")
          ...
          .addClass("is-success")
          .html('<strong>Thanks for your comment!</strong> It is <a href="https://github.com/wjbeckett/blog/pulls">currently pending</a> and will show on the site once approved.');
      ...
      error: function(err) {
        ...
        $("#js-notice")
          ...
          .addClass("is-danger")
          .html("<strong>Sorry, there was an error with your submission.</strong> Please make sure all required fields have been completed and try again.");
